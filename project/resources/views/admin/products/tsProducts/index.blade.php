...
@section('title' , trans('admin.products.title_tsProducts'))
@section('content')
    <section class="row">
        <article class="col-md-12">
            <h1 class="title_main text-center">
                {{ trans('admin.products.title_tsProducts') }}
                <span>
                    {{ trans('admin.products.description_tsProducts') }}
                </span>
            </h1>
        </article>
    </section>
    ...
    <!-- Section Filter -->
    {!! Form::model(Request::all(),['route' => 'admin.tsProducts.index', 'method' => 'GET' , 'class' => 'row margin-xs-bottom no-margin-md-bottom' ])!!}
    ...
    <article class="col-md-4 col-sm-6 text-sm-center">
        <ul class="list-inline text-xs-center text-md-left">
            ...
            <li class="text-left">
                <a class="btn btn-danger" href="{{ route('admin.tsProducts.index') }}">
    ...
    <article class="col-sm-6 col-md-4 col-xs-12">
        <ul class="list-inline text-md-right text-xs-center margin-xs-top no-margin-sm-top">
            <li class="col-md-offset-5 col-xs-offset-0">
                <a class="btn btn-success" href="{{ route('admin.tsProducts.create') }}">
    ...
    <section class="">
        {!! Form::open(['route' => ['admin.tsProducts.destroy', ':VALUE_ID'], 'method' => 'DELETE', 'class' => '' , 'id' => 'form-active'])!!}
        {!! Form::close()!!}
    </section>
