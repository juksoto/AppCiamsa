...
@section('title' , trans('admin.products.title_categories'))
@section('content')
    <section class="row">
        <article class="col-md-12">
            <h1 class="title_main text-center">
                {{ trans('admin.products.title_categories') }}
                <span>
                    {{ trans('admin.products.description_categories') }}
                </span>
            </h1>
        </article>
    </section>
    ...
    <!-- Section Filter -->
    {!! Form::model(Request::all(),['route' => 'admin.products.categories.index', 'method' => 'GET' , 'class' => 'row margin-xs-bottom no-margin-md-bottom' ])!!}
    ...
    <article class="col-md-4 col-sm-6 text-sm-center">
        <ul class="list-inline text-xs-center text-md-left">
            ...
            <li class="text-left">
                <a class="btn btn-danger" href="{{ route('admin.products.categories.index') }}">
    ...
    <article class="col-sm-6 col-md-4 col-xs-12">
        <ul class="list-inline text-md-right text-xs-center margin-xs-top no-margin-sm-top">
            <li class="col-md-offset-5 col-xs-offset-0">
                <a class="btn btn-success" href="{{ route('admin.products.categories.create') }}">
    ...
    <section class="row row-centered">
        <section class="col-md-12">
            @include('admin.products.categories.partials.table')
        </section>
    </section>

    <section class="">
        {!! Form::open(['route' => ['admin.products.categories.destroy', ':VALUE_ID'], 'method' => 'DELETE', 'class' => '' , 'id' => 'form-active'])!!}
        {!! Form::close()!!}
    </section>
