...
@section('content')
    ...
    <section class="row">
        <article class="col-md-12">
            <h1>
                {!! trans('admin.crops.edit_stage_crops') !!}
            </h1>
            <p>
                {!! trans('admin.crops.content_header_stage_crops_edit') !!}
            </p>
        </article>
    </section>


    {!! Form::model($data -> collection,['route' => ['admin.crops.stage.update', $data -> collection], 'method' => 'PUT', 'class' => 'form-horizontal',  'id' => 'form' , 'files' => true])!!}
    ...
    <section class="form-group">
        ...
        <article class="col-md-offset-4 col-md-2 col-sm-6 col-xs-12 col-sm-offset-0 text-sm-right text-xs-center margin-xs-top no-margin-sm-top">
            ...
            {!! Form::open(['route' => ['admin.crops.stage.destroy', $data -> collection], 'method' => 'DELETE', 'class' => '' ])!!}
